...
const tabOptions = ["Consultation overview", "Reviews"];
  ...
  <Stack>
    <Flex direction="column" p="2rem" bg="brand.white">
      <Box py="1rem">
        ...
        <Text py="1rem" fontSize="14px" color="brand.grey.400">
          Lorem ipsum dolor sit amet consectetur. Varius in convallis gravida
          sagittis faucibus est dignissim nunc diam. Et egestas vulputate sed
          aliquam
        </Text>
      </Box>
    ...
    <Flex rounded="lg" direction="column" p="2rem" bg="brand.white">
      ...
      <Flex mt="1rem" gap=".5rem">
        ...
        <Text fontSize="12px">
          Lorem ipsum dolor sit amet consectetur. Placerat tellus purus faucibus
          viverra sit. Augue eu fringilla faucibus mauris ultrices risus commodo
          justo magna. Mauris amet tincidunt ac.
        </Text>
      </Flex>
      <Flex mt="1rem" gap=".5rem">
        <Box>
        ...
        <Flex flex="1" gap="4">
          ...
          <Box>
            <Box display="flex" flexDirection="column">
              <Heading fontSize="20px" color="brand.grey.700">
                Adigun kofoworola Aduke
              </Heading>
              <Text py=".5rem" fontSize="12px" color="brand.grey.400">
                Enterpreneur & Designer &bull; Founder of shiftride
              </Text>
...
const Reviews = () => (
  <Box bg="brand.white">
    <Flex justifyContent="space-between" p="1rem">
      ...
      <Menu>
        <MenuButton color="brand.grey.400" fontSize="12px">
          5 Star rating &#x25BC;
        </MenuButton>
        <MenuList>
          <MenuItem as="a" href="#">
        ...
        <Flex flex="1" gap="4">
          ...
          <Box>
            <Box display="flex" alignItems="center" gap="1rem">
              <Heading size="xs">Segun Adebayo</Heading>&bull;
              <Text fontSize="12px" color="brand.grey.400">
                1 week ago
              </Text>
            </Box>
            <Flex>
...
const tabView = [
  <ConsultationOverview key="c=overview" />,
  <Reviews key="consultation" />,
];
    ...
    <MainLayout>
      <ConsultationWrapper>
        ...
        <Box m="1rem">
          ...
          <Grid
            templateColumns="repeat(auto-fit, minmax(337px, 1fr))"
            gap="1rem"
          >
            <GridItem>
              <ConsultionCard />
